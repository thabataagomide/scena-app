...
import { mapTmdbToSeriesDetails, mapTmdbTvToSeries, parseTmdbId } from "./tmdb/tmdb.mapper";
import type {
  MediaTitle,
  RecentlyReleased,
  Series,
...
const SERIES_DB: Record<string, SeriesDetails> = {
      ...
      1: [
        {
          ...
          rating: 4.6,
          overview:
            "Mark é promovido a chefe da equipe da divisão de refinamento de macro-dados cortados.",
        },
        {
          episodeNum: 2,
          title: "Half Loop",
          ...
          rating: 4.5,
          overview:
            "A equipe treina a nova recruta Helly, que logo começa a se rebelar contra as regras.",
        },
        {
          episodeNum: 3,
          title: "In Perpetuity",
          ...
          rating: 4.7,
          overview:
            "Helly tenta enviar uma mensagem para sua versão externa enquanto Irving faz descobertas.",
        },
        {
          episodeNum: 4,
          ...
          airDate: "11 Mar 2022",
          rating: 4.6,
          overview: "Mark encontra um livro de autoajuda misterioso deixado por um ex-funcionário.",
        },
        {
          episodeNum: 5,
          title: "The Grim Barbarity of Baird Creek",
          runtime: "44m",
          airDate: "18 Mar 2022",
          rating: 4.8,
          overview: "A equipe de refinamento explora novas salas enquanto as tensões aumentam.",
        },
        {
          episodeNum: 6,
          title: "Hide and Seek",
          ...
          airDate: "25 Mar 2022",
          rating: 4.7,
          overview: "Mark e Helly tentam escapar do andar de corte enquanto Cobel interfere.",
        },
        {
          episodeNum: 7,
          title: "Defiant Jazz",
          ...
          airDate: "1 Abr 2022",
          rating: 4.9,
          overview: "O grupo orquestra um plano audacioso para se conectar com o mundo externo.",
        },
        {
          episodeNum: 8,
          ...
          rating: 4.8,
          overview:
            "Tensões explodem durante o Jantar dos Fundadores enquanto segredos surgem à tona.",
        },
        {
          episodeNum: 9,
          title: "The We We Are",
          ...
          rating: 5.0,
          overview:
            "O plano é executado e revelações chocantes mudam tudo sobre o que sabíamos da Lumon.",
        },
      ],
      2: [
        {
          ...
          rating: 4.7,
          overview:
            "Mark e Helly tentam entender as consequências das revelações de suas identidades externas.",
        },
        {
          episodeNum: 2,
          ...
          airDate: "30 Jan 2025",
          rating: 4.8,
          overview: "Dylan descobre segredos chocantes sobre as operações secretas da Lumon.",
        },
        {
          episodeNum: 3,
          title: "The We We Are",
          ...
          airDate: "6 Fev 2025",
          rating: 4.9,
          overview: "A equipe elabora um plano arriscado para se libertar definitivamente.",
        },
        {
          episodeNum: 4,
          title: "Woe's Hollow",
          ...
          airDate: "13 Fev 2025",
          rating: 4.7,
          overview: "Cobel endurece sua fiscalização e Mark enfrenta uma nova rodada de testes.",
        },
        {
          episodeNum: 5,
          title: "Sunder",
          ...
          airDate: "20 Fev 2025",
          rating: 4.8,
          overview: "A mente de Mark começa a falhar entre seus dois lados.",
        },
        {
          episodeNum: 6,
          title: "Attila",
          ...
          airDate: "27 Fev 2025",
          rating: 4.9,
          overview: "Um novo personagem desafia o equilíbrio frágil dentro da Lumon.",
        },
      ],
    },
    comments: [
      {
        user: { name: "Lucas Melo", avatar: AV("luke") },
        comment:
          "Essa é a melhor série de ficção científica da década. A direção de arte é perfeita.",
        time: "há 2 dias",
        likes: 45,
        rating: 5,
      },
      {
        user: { name: "Mariana Costa", avatar: AV("mariana") },
        comment: "O final da primeira temporada me deixou sem respirar por horas. Genial!",
        time: "há 5 dias",
        likes: 32,
        rating: 5,
      },
      {
        user: { name: "Rafael Duarte", avatar: AV("rafael") },
        comment:
          "A atuação do Adam Scott é subestimada. Ele carrega dois personagens com maestria.",
        time: "há 1 sem",
        likes: 28,
        rating: 4,
      },
  ...
  theBear: {
    ...
    seasonsCount: 3,
    streamingPlatforms: [
      { name: "Disney+", logoColor: "bg-[#00003c] border-[#1a1a6c]/80 text-white" },
    ],
    cast: [
      ...
      1: [
        {
          ...
          rating: 4.4,
          overview:
            "Carmy assume a lanchonete de sua família e tenta modernizar os processos antigos.",
        },
        {
          episodeNum: 2,
          title: "Hands",
          ...
          rating: 4.5,
          overview:
            "A inspeção sanitária revela falhas e Carmy confronta Richie sobre sua atitude.",
        },
        {
          episodeNum: 3,
          title: "Right",
          ...
          airDate: "30 Jun 2022",
          rating: 4.6,
          overview: "A equipe precisa fechar o dia com vendas recorde para sobreviver ao mês.",
        },
      ],
      2: [
        {
          ...
          airDate: "22 Jun 2023",
          rating: 4.6,
          overview: "O plano de abrir um restaurante de alta gastronomia começa a tomar forma.",
        },
        {
          episodeNum: 2,
          title: "Pasta",
          ...
          airDate: "22 Jun 2023",
          rating: 4.7,
          overview: "Marcus vai para Copenhague aprender com os melhores chefs do mundo.",
        },
        {
          episodeNum: 3,
          title: "Sundae",
          ...
          airDate: "29 Jun 2023",
          rating: 4.5,
          overview: "A abertura do Bear se aproxima e cada detalhe precisa ser perfeito.",
        },
      ],
      3: [
        {
          ...
          airDate: "27 Jun 2024",
          rating: 4.7,
          overview: "O restaurante abre as portas sob extrema pressão e o caos culinário domina.",
        },
        {
          episodeNum: 2,
          title: "Next",
          ...
          airDate: "27 Jun 2024",
          rating: 4.6,
          overview: "Marcus treina novas receitas enquanto Carmy redefine o menu completo.",
        },
        {
          episodeNum: 3,
          title: "Thunder",
          ...
          airDate: "4 Jul 2024",
          rating: 4.8,
          overview: "Richie organiza o salão principal e Sydney lida com as críticas da mídia.",
        },
      ],
    },
    comments: [
      {
        ...
        comment:
          "A edição dessa série é uma obra de arte. Transmite a ansiedade da cozinha como nenhuma outra.",
        time: "há 1h",
        likes: 88,
        rating: 5,
      },
      {
        user: { name: "Gabi Lima", avatar: AV("gabi") },
        comment: "O episódio 'Review' da T2 é provavelmente o melhor episódio de TV já feito.",
        time: "há 3 dias",
        likes: 61,
        rating: 5,
      },
      ...
      1: [
        {
          ...
          rating: 4.6,
          overview:
            "Duas irmãs órfãs causam confusão nas ruas de Piltover após um roubo misterioso.",
        },
        {
          episodeNum: 2,
          ...
          rating: 4.7,
          overview:
            "Jayce tenta defender suas pesquisas de magia científica no conselho acadêmico.",
        },
        {
          episodeNum: 3,
          ...
          rating: 4.9,
          overview:
            "O trágico destino separa Vi e Powder após o ataque ao laboratório subterrâneo.",
        },
        {
          episodeNum: 4,
          ...
          airDate: "13 Nov 2021",
          rating: 4.8,
          overview: "Anos depois, Vi está presa enquanto Jinx semeia o caos em Piltover.",
        },
        {
          episodeNum: 5,
          ...
          airDate: "13 Nov 2021",
          rating: 4.7,
          overview: "Vi e Jinx se reúnem em circunstâncias devastadoras.",
        },
        {
          episodeNum: 6,
          ...
          airDate: "13 Nov 2021",
          rating: 4.8,
          overview: "O conselho de Piltover tenta contornar a ameaça crescente de Zaun.",
        },
        {
          episodeNum: 7,
          ...
          airDate: "20 Nov 2021",
          rating: 4.6,
          overview: "Ekko confronta Jinx em uma batalha carregada de emoção e nostalgia.",
        },
        {
          episodeNum: 8,
          title: "Oil and Water",
          ...
          airDate: "20 Nov 2021",
          rating: 4.7,
          overview: "Caitlyn e Vi precisam superar suas diferenças em busca de aliados.",
        },
        {
          episodeNum: 9,
          ...
          airDate: "20 Nov 2021",
          rating: 5.0,
          overview: "O destino de Piltover e Zaun é selado em uma conclusão épica e devastadora.",
        },
      ],
      2: [
        {
          ...
          rating: 4.8,
          overview:
            "Vi e Jinx tomam caminhos opostos enquanto a guerra entre as duas cidades eclode.",
        },
        {
          episodeNum: 2,
          title: "Some Mysteries…",
          runtime: "44m",
          airDate: "9 Nov 2024",
          rating: 4.7,
          overview: "Jinx lidera uma milícia enquanto os conselhos decidem o futuro de Piltover.",
        },
        {
          episodeNum: 3,
          ...
          airDate: "16 Nov 2024",
          rating: 4.9,
          overview: "O confronto final entre irmãs se torna inevitável.",
        },
      ],
    },
    comments: [
      {
        user: { name: "Pedro F.", avatar: AV("pedro") },
        comment: "Visualmente o maior feito da animação mundial. Trilha sonora impecável.",
        time: "há 3 dias",
        likes: 104,
        rating: 5,
      },
      {
        user: { name: "Alice R.", avatar: AV("alice") },
        comment: "Não consigo acreditar que uma série baseada em game seja tão emocionante.",
        time: "há 1 sem",
        likes: 78,
        rating: 5,
      },
      ...
      1: [
        {
          ...
          airDate: "01 Out 2023",
          rating: 4.4,
          overview: "Introdução dos personagens centrais e conflito inicial.",
        },
        {
          episodeNum: 2,
          title: "O Desdobramento",
          runtime: "43m",
          airDate: "08 Out 2023",
          rating: 4.5,
          overview: "A trama se complica com novas pistas reveladas.",
        },
        {
          episodeNum: 3,
          title: "Revelações",
          ...
          airDate: "15 Out 2023",
          rating: 4.6,
          overview: "O passado dos personagens começa a se revelar de forma surpreendente.",
        },
      ],
      2: [
        {
          ...
          airDate: "12 Set 2024",
          rating: 4.6,
          overview: "Novas intrigas começam após as consequências do final da temporada.",
        },
        {
          episodeNum: 2,
          title: "O Retorno",
          ...
          airDate: "19 Set 2024",
          rating: 4.5,
          overview: "Os personagens encaram as consequências de suas escolhas.",
        },
      ],
    },
    comments: [
      {
        user: { name: "Cinéfilo Scena", avatar: AV("cin") },
        comment: "Muito boa produção, vale a pena maratonar no final de semana.",
        time: "há 1 semana",
        likes: 12,
        rating: 4,
      },
